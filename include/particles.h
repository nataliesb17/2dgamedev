...
*/
void particle_spray(Vector2D position, Vector2D direction, Color color, Uint32 count, ParticleEmitter pe);

/**
* @brief make a trail from a shape
*/
void particle_trail(Vector2D start, Vector2D end, Color color, ParticleEmitter pe);
